...
class FilterViewController: UIViewController {
    ...
    private func performGetFilteredContent() {
        ...
        ContentClient.shared.filterContent(filterRequest: FilterContentRequest(filterBy: [FilterBy(path: "/_meta/schema", value: "https://example.com/blog-post-filter-and-sort"), FilterBy(path: "/category", value: category)], sortBy: SortBy(key: "readTime", order: selectedSort == "ASC" ? .ASC : .DESC), page: nil)) { [weak self] response, error in
